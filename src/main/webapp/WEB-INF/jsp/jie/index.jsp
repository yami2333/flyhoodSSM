...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/fly/res/css/mricode.pagination.css">
    ...
    <script src="${pageContext.request.contextPath}/fly/res/mricode.pagination.js"></script>
    <script>
        $(function () {
            // 发送ajax查询需要的数据以及记录总数
            $("#page").pagination({
...
<%--                模板--%>
                <script id="artmodel" type="text/html">
                    {{each list as artinfo}}
                    <li>
                        <a href="user/home.html" class="fly-avatar">
                            <img src="${pageContext.request.contextPath}/fly/res/images/avatar/{{artinfo.headurl}}" alt="贤心">
                        </a>
                        <h2>
                            <a class="layui-badge">{{artinfo.typename}}</a>
                            <a href="${pageContext.request.contextPath}/article/show?artid={{artinfo.aid}}">{{artinfo.title}}</a>
                        </h2>
                        <div class="fly-list-info">
                            <a href="user/home.html" link>
                                <cite>{{artinfo.nickname}}</cite>
                                <!--
                                <i class="iconfont icon-renzheng" title="认证信息：XXX"></i>
                                <i class="layui-badge fly-badge-vip">VIP3</i>
                                -->
                            </a>
                            <span>{{artinfo.releasetime}}</span>

                            <span class="fly-list-kiss layui-hide-xs" title="悬赏飞吻"><i class="iconfont icon-kiss"></i> {{artinfo.paykiss}}</span>
                            {{if artinfo.isend != 0}}
                                <span class="layui-badge fly-badge-accept layui-hide-xs">已结</span>
                            {{/if}}
                            <span class="fly-list-nums">
                                <i class="iconfont icon-pinglun1" title="回答"></i> {{artinfo.commnum}}
                            </span>
                        </div>
                ...
                <div style="text-align: center;padding-left:120px;">
                    <%--       创建分页显示标签       --%>
                    <div id="page" class="m-pagination" style="text-align: center"></div>
                </div>
