            ...
            <c:if test="${login_user != null}">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="${pageContext.request.contextPath}/go/set"><i class="layui-icon">&#xe620;</i>基本设置</a></dd>
...
<div class="fly-panel fly-column">
    <div class="layui-container">
        ...
        <div class="fly-column-right layui-hide-xs">
            ...
            <a href="${pageContext.request.contextPath}/go/recheck" class="layui-btn">发表新帖</a>
        </div>
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md8">
            <div class="fly-panel">
                ...
                <%--指定文章信息--%>
                <ul class="fly-list">
                    <c:if test="${topArticleList != null}">
                        <c:forEach items="${topArticleList}" var="top">
                            <li>
                                <a href="user/home.html" class="fly-avatar">
                                    <img src="${pageContext.request.contextPath}/fly/res/images/avatar/${top.headurl}"
                                         alt="贤心">
                                </a>
                                <h2>
                                    <a class="layui-badge">${top.typename}</a>
                                    <a target="_blank" href="${pageContext.request.contextPath}/article/show?artid=${top.aid}">${top.title}</a>
                                </h2>
                                <div class="fly-list-info">
                                    ...
                                    <span>${top.releasetime}</span>
                                    <span class="fly-list-kiss layui-hide-xs" title="悬赏飞吻"><i class="iconfont icon-kiss"></i> ${top.paykiss}</span>
                                    <c:if test="${top.isend != 0}">
                                        <span class="layui-badge fly-badge-accept layui-hide-xs">已结</span>
                                    </c:if>
                                    <span class="fly-list-nums">
                                        <i class="iconfont icon-pinglun1" title="回答"></i> ${top.commnum}
                                    </span>
                                </div>
                                <div class="fly-list-badge">
                                    <c:if test="${top.istop != 0}">
                                        <span class="layui-badge layui-bg-black">置顶</span>
                                    </c:if>
                                    <c:if test="${top.iscream != 0}">
            ...
            <a href="">按热议</a>
                ...
                <ul class="fly-list">
                    <c:if test="${articleList != null}">
                        <c:forEach items="${articleList}" var="article">
                            <li>
                                <a href="user/home.html" class="fly-avatar">
                                    <img src="${pageContext.request.contextPath}/fly/res/images/avatar/${article.headurl}"
                                         alt="贤心">
                                </a>
                                <h2>
                                    <a class="layui-badge">${article.typename}</a>
                                    <a href="${pageContext.request.contextPath}/article/show?artid=${article.aid}">${article.title}</a>
                                </h2>
                                <div class="fly-list-info">
                                    <a href="user/home.html" link>
                                    ...
                                    <span class="fly-list-kiss layui-hide-xs" title="悬赏飞吻"><i class="iconfont icon-kiss"></i> ${article.paykiss}</span>
                                        <c:if test="${article.isend == 1}">
                                            <span class="layui-badge fly-badge-accept layui-hide-xs">已结</span>
                                        </c:if>

                                    <span class="fly-list-nums">
                <i class="iconfont icon-pinglun1" title="回答"></i> ${article.commnum}
              </span>
                                </div>
                                <div class="fly-list-badge">
                                    <c:if test="${article.iscream == 1}">
                                        <span class="layui-badge layui-bg-red">精帖</span>
                                    </c:if>
                                    <!--<span class="layui-badge layui-bg-red">精帖</span>-->
                                </div>
                ...
                <div style="text-align: center">
                    <div class="laypage-main">
                        <a href="${pageContext.request.contextPath}/go/indexTwo" class="laypage-next">更多求解</a>
                    </div>
                </div>
...
<script>
    ...
    layui.config({
        version: "3.0.0"
        , base: '${pageContext.request.contextPath}/fly/res/mods/' //这里实际使用时，建议改成绝对路径
    }).extend({
        fly: 'index'
    }).use('fly');
</script>
